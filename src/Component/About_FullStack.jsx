...
import "../Styles/AboutFullStack.css"

const About_FullStack = () => {
  return (
...
<div className="AboutCourse">
    ...
    <div className="Course">
     ...
     <div>
      <h2 className="curriculam_para1"> 1  Introduction to Full Stack Development</h2>
      <h2 className="curriculam_para2">2   HTML & CSS Basics </h2>
      <h2 className="curriculam_para3">3   JavaScript Fundamentals – Interactive Webpage Project  </h2>
      <h2 className="curriculam_para4">4   Advanced JavaScript (ES6+ Concepts) </h2>
      <h2 className="curriculam_para5">5   Front-end Frameworks – React Basics </h2>
      <h2 className="curriculam_para6">6   Styling Libraries and Responsive Design – Portfolio Project </h2>
      <h2 className="curriculam_para7">7   Joins  </h2>
      <h2 className="curriculam_para8">8   Database Fundamentals (SQL & NoSQL) </h2>
      <h2 className="curriculam_para9">9   Working with MongoDB – User Profile Project </h2>
      <h2 className="curriculam_para10">10  User Authentication and Authorization  </h2>
     </div> 
     </div>
...
export default About_FullStack